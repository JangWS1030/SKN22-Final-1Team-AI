...
SESSION_NAME="${SESSION_NAME:-hairgen_longtail_postprocess}"
LAUNCH_MODE="${LAUNCH_MODE:-tmux}"
mkdir -p "$STATE_ROOT" "$LOG_ROOT"

RUN_SCRIPT="$REPO_ROOT/scripts/run_longtail_postprocess.sh"
WRAPPER_SCRIPT="$STATE_ROOT/launch_longtail_postprocess.sh"
